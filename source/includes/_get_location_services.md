...
```shell
curl "https://ohana-api-211.herokuapp.com/api/locations/1/services" -H "User-Agent: MyClient/1.0.0"
```
...
`GET https://ohana-api-211.herokuapp.com/api/locations/:id/services`
